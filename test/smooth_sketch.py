...
# Lưu kết quả vào E:\Convert_Image\output_images với tên như 1_smooth_sketch.jpg
...
def main():
    ...
    print("Bắt đầu xử lý hiệu ứng smooth_sketch cho tất cả ảnh...")
    ...
    for i in range(1, 51):
        ...
        output_path = os.path.join(output_dir, f"{i}_smooth_sketch.jpg")
